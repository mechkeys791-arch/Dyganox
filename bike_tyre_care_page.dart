...
class _BikeTyreCarePageState extends State<BikeTyreCarePage> with TickerProviderStateMixin {
  ...
  String selectedTyreSize = '90/90-12';
    ...
    final tyreServices = [
      {
        ...
        'description': 'Quick on-spot puncture repair for bikes and scooters',
        'icon': 'assets/icons/punctured-tire.png',
        'price': '₹99',
      },
      {
        'title': 'Scooter Tyre Replacement',
        'description': 'New tyre installation for scooters with alignment',
        'icon': 'assets/icons/tires.png',
        'price': '₹1299',
      },
      {
        'title': 'Bike Wheel Balancing',
      ...
      },
      {
        ...
        'description': 'Inner tube replacement for bikes and scooters',
        'icon': 'assets/icons/punctured-tire.png',
        'price': '₹199',
      },
      {
        'title': 'Emergency Tyre Service',
        'description': '24/7 emergency tyre assistance for bikes',
    ...
    final nearbyMechanics = [
      {
        ...
        'rating': '4.8',
        'distance': '0.7 km',
        'speciality': 'Bike Puncture Expert',
      },
      {
        'name': 'Scooter Zone',
        'experience': '11 years',
        'rating': '4.9',
        'distance': '1.2 km',
        'speciality': 'Scooter Tyre Specialist',
      },
      {
        ...
        'rating': '4.7',
        'distance': '0.9 km',
        'speciality': 'Fast Puncture Repair',
      },
      {
        'name': 'Metro Bike Care',
        'experience': '8 years',
        'rating': '4.8',
        'distance': '1.8 km',
