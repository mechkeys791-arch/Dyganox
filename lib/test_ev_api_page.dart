...
class _TestEVAPIPageState extends State<TestEVAPIPage> {
  ...
  Future<void> _testConnection() async {
    ...
    try {
      _addLog('🔍 Testing: http://localhost:8081/api/evprovider');
  ...
  Future<void> _testPost() async {
    ...
    try {
      _addLog('📤 Sending POST to: http://localhost:8081/api/evprovider');
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const Text(
                  'Endpoint: http://localhost:8081/api/evprovider',
